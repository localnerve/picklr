...
function Picklr (startDir, options) {
  ...
  const defaultReplacementFilter = () => true;
  ...
  this.replacementFilter = options.replacementFilter || defaultReplacementFilter;
 ...
 */
export default function processAllFiles (startDir, options) {
